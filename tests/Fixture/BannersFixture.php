...
class BannersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'delete_flag' => ['type' => 'tinyinteger', 'length' => 3, 'unsigned' => true, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null],
        'is_active' => ['type' => 'tinyinteger', 'length' => 3, 'unsigned' => true, 'null' => true, 'default' => '1', 'comment' => '', 'precision' => null],
