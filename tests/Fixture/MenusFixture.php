...
class MenusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_active' => ['type' => 'integer', 'length' => 3, 'unsigned' => false, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_active' => 1,
                'created' => '2018-07-04 15:23:05',
                'modified' => '2018-07-04 15:23:05'
            ],
        ];
        parent::init();
    }
