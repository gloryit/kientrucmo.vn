        ...
        <div class="vtemboxgrid caption vtem-boxgrid" style="width: 337px; height: 225px; float: left;">
            ...
            <div class="box-caption vtem-slideItem" style="top: 189px; left: 0px;">
                <div class="vtemnewsbox_inside">
                    <h4 class="vtem_news_box_title boxTitle"><a href="<?= $this->Url->build(['_name' => 'services:view', $post->slug]) ?>"><?= h($post->title) ?></a></h4>
                    <div class="vt_readmore clearfix"><a class="vtem-newsbox-readon" href="<?= $this->Url->build(['_name' => 'services:view', $post->slug]) ?>"><span>Xem chi tiết ...</span></a></div>
                </div>
            </div>
        </div>
        <?php endforeach; ?>
