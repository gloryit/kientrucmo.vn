                                    ...
                                    <div class="span6">
                                        <div class="item column-1" itemprop="blogPost" itemscope="" itemtype="https://schema.org/BlogPosting">
                                            <div class="page-header">
                                                <h2 itemprop="name">
                                                    <a href="<?= $this->Url->build(['_name' => 'highlights:view', h($post->slug)]) ?>" itemprop="url"><?= h($post->title) ?></a>
                                                </h2>
                                            </div>
                                            <dl class="article-info muted">
                                                ...
                                                <dd class="category-name">Chuyên mục: <a href="<?= $this->Url->build(['_name' => 'app:highlights']) ?>" itemprop="genre"><?= $group->title ?></a></dd>
                                                <dd class="create">
                                            ...
                                            <p>
                                                <img property="image" src="<?= h($post->link_images) ?>" alt="00" width="350" height="247">
                                            </p>
                                        </div>
                                        <!-- end item -->
                                    </div>
