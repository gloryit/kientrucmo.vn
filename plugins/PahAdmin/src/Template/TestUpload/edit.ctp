 ...
 * @var \App\Model\Entity\Post $toppage_logo
 * @var \App\Model\Entity\WebsiteImage[] $logos
...
<div class="block">
    <div class="page-title">
        <div class="title_left">
            <h3>
                <a href="<?= $this->Url->build(['controller' => 'TestUpload', 'action' => 'edit', 'plugin' => 'PahAdmin']) ?>">UPLOAD IMAGE</a>
            </h3>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="row" style="padding-bottom: 50px">
                            <?php foreach ($logos as $logo): ?>
                                <div class="col-md-3">
                                    <img style="width: 150px" src="<?= $logo->uri ?>" alt="<?= $logo->name ?>">
                                </div>
                            <?php endforeach ?>
                        </div>
