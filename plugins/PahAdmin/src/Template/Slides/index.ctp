...
<div class="block">
    <div class="page-title">
        <div class="title_left">
            <h3>
                <a href="<?= $this->Url->build(array('controller' => 'Slides', 'action' => 'index', 'plugin' => 'PahAdmin')) ?>">
                    Slides
                </a>
            </h3>
        </div>
                ...
                <div class="x_content">
                    <div class="row">
                        ...
                        <div class="col-md-12 text-right">
                            <a href="<?= $this->Url->build(array('controller' => 'Slides', 'action' => 'edit', 'plugin' => 'PahAdmin')) ?>" id="s_reset" type="submit"
                               class="btn btn-primary">+ Create New Slides</a>
                        </div>
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    var edit_url = "<?= $this->Url->build(['plugin' => 'PahAdmin', 'controller' => 'Slides', 'action' => 'edit']) ?>/";
    var datatables_config = {
      ...
      "pageLength": 10,
      "ajax": {
        url: '<?= $this->Url->build(array('controller' => 'Slides', 'action' => 'datatables', 'plugin' => 'PahAdmin')) ?>',
        data: function (d) {
        }
      },
      "order": [[0, "desc"]],
      ...
      'columnDefs': [
        ...
        },
        {
          ...
          "render": function (data, type, full, meta) {
            return '<img src="' + data + '" alt="" height="200" width="500">';
          },
          "searchable": true,
          "orderable": true
        },
    ...
    $toppageLogo_table.on('click', '.delete_post', function (e) {
      ...
      if (confirm("Are you sure?")) {
        $.ajax({
          url: "<?= h($this->Url->build(['plugin' => 'PahAdmin', 'controller' => 'Slides', 'action' => 'delete'])) ?>",
          type: 'DELETE',
          dataType: 'JSON',
          data: {
            id: uri_id,
